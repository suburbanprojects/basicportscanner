...
class portscanThread(QThread):
    ...
    def __init__(self, address, startport, endport):
        super().__init__()
...
class portscanGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.setLayout(grid)
        self.resize(500, 350)
        self.setWindowTitle('Portscan GUI with Threading')
        self.show()
    ...
    def start_scan(self):
        ...
        try:
            ...
            return
        self.scanner_thread = portscanThread(address, startport, endport)
        self.scanner_thread.result_signal.connect(self.scan_output.append)
